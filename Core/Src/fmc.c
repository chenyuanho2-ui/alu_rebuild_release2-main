...
command.CommandTarget = FMC_SDRAM_CMD_TARGET_BANK1; // ѡ��Ҫ���Ƶ�����
command.AutoRefreshNumber = 1;
command.ModeRegisterDefinition = 0;
HAL_SDRAM_SendCommand(&hsdram1, &command, SDRAM_TIMEOUT); // ���Ϳ���ָ��,��3���ǵȴ�ʱ��
HAL_Delay(1);	// ��ʱ�ȴ� ���û��,����Ҳ����freertos���߳�������
...
HAL_SDRAM_ProgramRefreshRate(&hsdram1, 918); // ����ˢ����
